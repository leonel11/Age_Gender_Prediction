...
train_data = "/workspace/ssd_data/train_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/workspace/ssd_data/test_lmdb"
...
model_name = "VGG_gender_{}".format(job_name)
...
job_dir = "/workspace/jobs/VGGNet/{}".format(job_name)
